...
- (void)viewDidLoad {
    ...
    mainScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, DEVICE_WIDTH, DEVICE_HEIGHT-64-49)];
    [self.view addSubview:mainScrollView];
    UIBarButtonItem *shopClass = [[UIBarButtonItem alloc] initWithTitle:@"商品分类" style:UIBarButtonItemStylePlain target:self action:@selector(toShopClassVC)];
...
-(void)setUpView{
    ...
    [mainScrollView addSubview:cycleScrollView];
    height+=160;
    ...
    [mainScrollView addSubview:newVIPView];
    height+=50;
    ...
    [mainScrollView addSubview:classBackView];
    ...
    [mainScrollView addSubview:expandListBtn1];
    ...
    [mainScrollView addSubview:expandListBtn2];
    height+=152;
    
    mainScrollView.contentSize = SizeMake_LFL(375, height);
